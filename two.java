...
public class Hive_java{
  ...
  public static void main(String[] args) throws SQLException {
    ...
    state.executeQuery("load data inpath '/home/cloudera/employee.csv into table Employee;");
    System.out.println("!!!!!!!!!!Running 2nd query!!!!!!!!!!");
    state.executeQuery("load data inpath '/home/cloudera/salary.csv into table Salary;");
  }
}